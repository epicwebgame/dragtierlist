...
<style type="text/css">
#div1, #div2
{float:left; width:140px; height:55px; margin:10px;padding:10px;border:1px solid #aaaaaa;}
</style>
<script>
...
<div class="w3-container top">
  ...
  <div id="loginactioncontainer" class="w3-right">
    ...
    <a id="w3loginbtn" style="display: inline;" class="login w3-right" href="javascript:void(0);" onclick="w3_open_nav(&quot;login&quot;)">LOG IN</a>
  </div>
...
<div style="display: none; position: fixed; z-index: 3; right: 111px; height: 44px; background-color: rgb(95, 95, 95); text-align: right; padding-top: 9px; top: 0px;" id="google_translate_element"><div class="skiptranslate goog-te-gadget" dir="ltr" style=""><div id=":0.targetLanguage" class="goog-te-gadget-simple" style="white-space: nowrap;"><img src="https://www.google.com/images/cleardot.gif" class="goog-te-gadget-icon" alt="" style="background-image: url(&quot;https://translate.googleapis.com/translate_static/img/te_ctrl3.gif&quot;); background-position: -65px 0px;"><span style="vertical-align: middle;"><a aria-haspopup="true" class="goog-te-menu-value" href="javascript:void(0)"><span>Select Language</span><img src="https://www.google.com/images/cleardot.gif" alt="" width="1" height="1"><span style="border-left: 1px solid rgb(187, 187, 187);">​</span><img src="https://www.google.com/images/cleardot.gif" alt="" width="1" height="1"><span aria-hidden="true" style="color: rgb(118, 118, 118);">▼</span></a></span></div></div></div>
...
<div class="w3-card-2 topnav notranslate" id="topnav" style="position: fixed; top: 0px;">
  <div style="overflow:auto;">
    <div class="w3-bar w3-left" style="width:100%;overflow:hidden;height:44px">
      ...
      <a class="w3-bar-item w3-button w3-right w3-hide-medium" id="topnavbtn_exercises" href="javascript:void(0);" onclick="w3_open_nav(&quot;exercises&quot;)" title="Exercises">EXERCISES <i class="fa fa-caret-down" style="display: inline;"></i><i class="fa fa-caret-up" style="display:none"></i></a>
    </div>
    ...
    <div id="nav_login" class="w3-bar-block w3-card-2" style="display:none">
      <span onclick="w3_close_nav(&quot;login&quot;)" class="w3-button w3-xlarge w3-right" style="position:absolute;right:0;font-weight:bold;">×</span>
...
<a target="_top" href="html5_draganddrop.asp" class="active">HTML Drag/Drop</a>
  ...
  <div class="w3-row w3-white">
    <div class="w3-col l10 m12" id="main">
      <div id="mainLeaderboard" style="overflow:hidden;">
        ...
        <div id="div-gpt-ad-1422003450156-2" data-google-query-id="CJWapOuZ3ewCFQDauwgdeh8MQA">
          
        <div id="google_ads_iframe_/16833175/MainLeaderboard_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/16833175/MainLeaderboard_0" title="3rd party ad content" name="google_ads_iframe_/16833175/MainLeaderboard_0" width="970" height="90" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" srcdoc="" style="border: 0px; vertical-align: bottom;" data-google-container-id="1" data-load-complete="true"></iframe></div></div>
       
      </div>

<h1>HTML <span class="color_h1">Drag and Drop API</span></h1>
<div class="w3-clear nextprev">
<a class="w3-left w3-btn" href="html5_geolocation.asp">❮ Previous</a>
<a class="w3-right w3-btn" href="html5_webstorage.asp">Next ❯</a>
</div>
<hr>
<p class="intro">In HTML, any element can be dragged and dropped.</p>
<hr>

<h2>Example</h2>
<div id="div1" ondrop="drop(event)" ondragover="allowDrop(event)">
</div>
<div id="div2" ondrop="drop(event)" ondragover="allowDrop(event)"><img src="img_w3slogo.gif" draggable="true" ondragstart="drag(event)" id="drag1" alt="W3Schools"></div>
...
<div class="w3-code notranslate htmlHigh">
...
</span> <span class="jskeywordcolor" style="color:mediumblue">function</span> allowDrop(ev)<span class="jsnumbercolor" style="color:red">
</span> {<br><span class="jsnumbercolor" style="color:red">
</span> &nbsp;&nbsp;ev.<span class="jspropertycolor" style="color:black">preventDefault</span>();<br><span class="jsnumbercolor" style="color:red">
</span> }<br><span class="jsnumbercolor" style="color:red">
</span> <br><span class="jsnumbercolor" style="color:red">
</span> <span class="jskeywordcolor" style="color:mediumblue">function</span> drag(ev)<span class="jsnumbercolor" style="color:red">
</span> {<br><span class="jsnumbercolor" style="color:red">
</span>  &nbsp;<span class="jsnumbercolor" style="color:red">
</span> ev.<span class="jspropertycolor" style="color:black">dataTransfer</span>.<span class="jspropertycolor" style="color:black">setData</span>(<span class="jsstringcolor" style="color:brown">"text"</span>, ev.<span class="jspropertycolor" style="color:black">target</span>.<span class="jspropertycolor" style="color:black">id</span>);<br><span class="jsnumbercolor" style="color:red">
</span> }<br><span class="jsnumbercolor" style="color:red">
</span> <br><span class="jsnumbercolor" style="color:red">
</span> <span class="jskeywordcolor" style="color:mediumblue">function</span> drop(ev)<span class="jsnumbercolor" style="color:red">
</span> {<br><span class="jsnumbercolor" style="color:red">
</span>  &nbsp;<span class="jsnumbercolor" style="color:red">
</span> ev.<span class="jspropertycolor" style="color:black">preventDefault</span>();<br><span class="jsnumbercolor" style="color:red">
</span> &nbsp;&nbsp;<span class="jskeywordcolor" style="color:mediumblue">var</span> data = ev.<span class="jspropertycolor" style="color:black">dataTransfer</span>.<span class="jspropertycolor" style="color:black">getData</span>(<span class="jsstringcolor" style="color:brown">"text"</span>);<br><span class="jsnumbercolor" style="color:red">
</span> &nbsp;&nbsp;ev.<span class="jspropertycolor" style="color:black">target</span>.<span class="jspropertycolor" style="color:black">appendChild</span>(document.<span class="jspropertycolor" style="color:black">getElementById</span>(data));<br><span class="jsnumbercolor" style="color:red">
</span> }<br><span class="jsnumbercolor" style="color:red">
 ...
 <br>
 <span class="tagnamecolor" style="color:brown"><span class="tagcolor" style="color:mediumblue">&lt;</span>div<span class="attributecolor" style="color:red"> id<span class="attributevaluecolor" style="color:mediumblue">="div1"</span> ondrop<span class="attributevaluecolor" style="color:mediumblue">="drop(event)"</span>
 ondragover<span class="attributevaluecolor" style="color:mediumblue">="allowDrop(event)"</span></span><span class="tagcolor" style="color:mediumblue">&gt;</span></span><span class="tagnamecolor" style="color:brown"><span class="tagcolor" style="color:mediumblue">&lt;</span>/div<span class="tagcolor" style="color:mediumblue">&gt;</span></span><br>
 <br>
 <span class="tagnamecolor" style="color:brown"><span class="tagcolor" style="color:mediumblue">&lt;</span>img<span class="attributecolor" style="color:red"> id<span class="attributevaluecolor" style="color:mediumblue">="drag1"</span> src<span class="attributevaluecolor" style="color:mediumblue">="img_logo.gif"</span> draggable<span class="attributevaluecolor" style="color:mediumblue">="true"</span>
 ondragstart<span class="attributevaluecolor" style="color:mediumblue">="drag(event)"</span> width<span class="attributevaluecolor" style="color:mediumblue">="336"</span> height<span class="attributevaluecolor" style="color:mediumblue">="69"</span></span><span class="tagcolor" style="color:mediumblue">&gt;</span></span><br>
 <br>
 <span class="tagnamecolor" style="color:brown"><span class="tagcolor" style="color:mediumblue">&lt;</span>/body<span class="tagcolor" style="color:mediumblue">&gt;</span></span><br>
...
<a class="w3-btn w3-margin-bottom" href="tryit.asp?filename=tryhtml5_draganddrop" target="_blank">Try it Yourself »</a></div>
...
<!-- <p class="adtext">Advertisement</p> -->
  ...
  <div id="div-gpt-ad-1493883843099-0" style="" data-google-query-id="CJqapOuZ3ewCFQDauwgdeh8MQA">
    
  <div id="google_ads_iframe_/16833175/MidContent_0__container__" style="border: 0pt none;"><iframe id="google_ads_iframe_/16833175/MidContent_0" title="3rd party ad content" name="google_ads_iframe_/16833175/MidContent_0" width="970" height="250" scrolling="no" marginwidth="0" marginheight="0" frameborder="0" srcdoc="" style="border: 0px; vertical-align: bottom;" data-google-container-id="6" data-load-complete="true"></iframe></div></div>
...
<div class="w3-code w3-border notranslate jsHigh"><span class="jscolor" style="color:black"><div>
 &lt;img draggable=<span class="jsstringcolor" style="color:brown">"true"</span>&gt;</div> </span></div>
<hr>
...
<div>
<span class="jskeywordcolor" style="color:mediumblue">function</span> drag(ev) {<br>&nbsp; ev.<span class="jspropertycolor" style="color:black">dataTransfer</span>.<span class="jspropertycolor" style="color:black">setData</span>(<span class="jsstringcolor" style="color:brown">"text"</span>, ev.<span class="jspropertycolor" style="color:black">target</span>.<span class="jspropertycolor" style="color:black">id</span>);<br><span class="jsnumbercolor" style="color:red">
</span>}
</div> </span></div>
...
<div class="w3-code w3-border notranslate jsHigh"><span class="jscolor" style="color:black"><span class="jsnumbercolor" style="color:red">
</span> <div>
  <i><span class="jskeywordcolor" style="color:mediumblue">event</span></i>.<span class="jspropertycolor" style="color:black">preventDefault</span>()</div>
 </span></div>
<hr>
...
<div class="w3-code w3-border notranslate jsHigh"><span class="jscolor" style="color:black"><span class="jsnumbercolor" style="color:red">
  ...
  <span class="jskeywordcolor" style="color:mediumblue">function</span> drop(ev)<span class="jsnumbercolor" style="color:red">
</span> {<br><span class="jsnumbercolor" style="color:red">
</span>   &nbsp;<span class="jsnumbercolor" style="color:red">
</span> ev.<span class="jspropertycolor" style="color:black">preventDefault</span>();<br><span class="jsnumbercolor" style="color:red">
</span>   &nbsp;<span class="jsnumbercolor" style="color:red">
...
<a class="w3-btn w3-margin-bottom w3-margin-top" href="tryit.asp?filename=tryhtml5_draganddrop2" target="_blank">Try it Yourself »</a></div>
...
<div class="sidesection">
  <div id="skyscraper">
    ...
    <div id="div-gpt-ad-1422003450156-5" data-google-query-id="CJaapOuZ3ewCFQDauwgdeh8MQA" style="min-height: 0px;">
       
    <div id="google_ads_iframe_/16833175/WideSkyScraper_0__container__" style="border: 0pt none; display: inline-block; width: 160px; height: 600px;"><iframe frameborder="0" src="https://25ae8b96d9d1299fc58b93de113060f8.safeframe.googlesyndication.com/safeframe/1-0-37/html/container.html" id="google_ads_iframe_/16833175/WideSkyScraper_0" title="3rd party ad content" name="" scrolling="no" marginwidth="0" marginheight="0" width="160" height="600" data-is-safeframe="true" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" data-google-container-id="2" style="border: 0px; vertical-align: bottom;" data-load-complete="true"></iframe></div></div>
...
//-->
</script><a href="http://www.facebook.com/sharer.php?u=https://www.w3schools.com/html/html5_draganddrop.asp" target="_blank" title="Facebook"><span class="fa fa-facebook-square fa-2x"></span></a><a href="https://twitter.com/home?status=Currently reading https://www.w3schools.com/html/html5_draganddrop.asp" target="_blank" title="Twitter"><span class="fa fa-twitter-square fa-2x"></span></a>
...
<div id="stickypos" class="sidesection" style="text-align: center; position: sticky; top: 50px;">
  <div id="stickyadcontainer" style="width: 944.984px; top: 60px;">
    <div style="position:relative;margin:auto;">
        ...
        </script><div id="div-gpt-ad-1472547360578-0" style="display: none;"></div>
...
<div style="overflow:auto">
  ...
  <div class="bottomad" id="div-gpt-ad-1422003450156-0" data-google-query-id="CJeapOuZ3ewCFQDauwgdeh8MQA">
    
  <div id="google_ads_iframe_/16833175/BottomMediumRectangle_0__container__" style="border: 0pt none; display: inline-block; width: 300px; height: 250px;"><iframe frameborder="0" src="https://25ae8b96d9d1299fc58b93de113060f8.safeframe.googlesyndication.com/safeframe/1-0-37/html/container.html" id="google_ads_iframe_/16833175/BottomMediumRectangle_0" title="3rd party ad content" name="" scrolling="no" marginwidth="0" marginheight="0" width="300" height="250" data-is-safeframe="true" sandbox="allow-forms allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts allow-top-navigation-by-user-activation" data-google-container-id="3" style="border: 0px; vertical-align: bottom;" data-load-complete="true"></iframe></div></div>
  <!-- RightBottomMediumRectangle -->
  <div class="bottomad" id="div-gpt-ad-1422003450156-3" style="display: none;">
...
</div><iframe name="__tcfapiLocator" style="display: none;"></iframe><iframe name="__uspapiLocator" style="display: none;"></iframe><iframe name="__cmpLocator" style="display: none;"></iframe>
...
<div id="goog-gt-tt" class="skiptranslate" dir="ltr"><div style="padding: 8px;"><div><div class="logo"><img src="https://www.gstatic.com/images/branding/product/1x/translate_24dp.png" width="20" height="20" alt="Google Translate"></div></div></div><div class="top" style="padding: 8px; float: left; width: 100%;"><h1 class="title gray">Original text</h1></div><div class="middle" style="padding: 8px;"><div class="original-text"></div></div><div class="bottom" style="padding: 8px;"><div class="activity-links"><span class="activity-link">Contribute a better translation</span><span class="activity-link"></span></div><div class="started-activity-container"><hr style="color: #CCC; background-color: #CCC; height: 1px; border: none;"><div class="activity-root"></div></div></div><div class="status-message" style="display: none;"></div></div><table cellspacing="0" cellpadding="0" class="gstl_50 gssb_c" style="width: 2px; display: none; top: 3px; position: absolute; left: -1px;"><tbody><tr><td class="gssb_f"></td><td class="gssb_e" style="width: 100%;"></td></tr></tbody></table><div class="goog-te-spinner-pos"><div class="goog-te-spinner-animation"><svg xmlns="http://www.w3.org/2000/svg" class="goog-te-spinner" width="96px" height="96px" viewBox="0 0 66 66"><circle class="goog-te-spinner-path" fill="none" stroke-width="6" stroke-linecap="round" cx="33" cy="33" r="30"></circle></svg></div></div><iframe frameborder="0" class="goog-te-menu-frame skiptranslate" title="Language Translate Widget" style="visibility: visible; box-sizing: content-box; width: 1054px; height: 263px; display: none;"></iframe><iframe id="google_osd_static_frame_8188318356830" name="google_osd_static_frame" style="display: none; width: 0px; height: 0px;"></iframe></body></html>
